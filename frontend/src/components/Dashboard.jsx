            ...
            <li>
              <Link to="/admin/dashboard" className='active'>
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <rect x="0.5" y="0.5" width="8" height="11" fill="black" stroke="black" />
                  <rect x="11.5" y="0.5" width="8" height="5" fill="black" stroke="black" />
                  <rect x="19.5" y="19.5" width="8" height="11" transform="rotate(-180 19.5 19.5)" fill="black" stroke="black" />
                  <rect x="8.5" y="19.5" width="8" height="5" transform="rotate(-180 8.5 19.5)" fill="black" stroke="black" />
                </svg>
                Dashboard
              </Link>
            </li>
